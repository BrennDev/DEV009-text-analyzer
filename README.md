...
***
## 1. Informacion del sitio Web "Analizador de Textos"
...
![Prueba](/docs/images/Preview-2.gif)
...
La aplicación pasa los test 

![Prueba](/docs/images/test.gif)
#### Deploy

Los sitios estan publicados (o _desplegados_) para que usuarias de
la web puedan acceder a él..

En este proyecto se utiliza _Github Pages_ para desplegar nuestro sitio web.


## 5. Criterios del proyecto

A continuación se muestra los criterios utilizados en el proyecto
...
* **Uso de HTML semántico**
  ...
  con texto `Analizador de texto`. Estos
  ...
  uno para muestra cada métrica.  Estos
  elementos no tienen atributos `id` ni `name`.
  ...
  Estos elementos no tienen atributos `id`, ni `name`, ni `class`.
...
* **Manipulación dinámica del DOM**
  ...
  de los `<li>` que muestra las métricas del texto.
